...
const MARKDOWN_DESCRIPTION = `## Business Accelerator & Mentorship

This is not marketing. This is **infrastructure** — a system that runs daily, captures demand, and turns attention into booked jobs alongside a personal mentorship with Todd and team.
...
**9. Monthly Mentorship with Todd Pultz**

6 months, one private 1-on-1 call monthly with Todd:
- Direct access to strategic guidance
- Scaling, decision-making, and growth direction
...
This is for **serious entrepreneurs** who want Todd in their corner every step of the way.`;

async function main() {
  const updated = await prisma.course.update({
    where: { id: 'ht_done_with_you' },
